                ...
                @if (isset($category))
                    @foreach($category as $category)
                        @if ($category->subCatExperiences->count() !=0)
                            ...
                            <div class="row">
                                    <div class="col-lg-12 col-md-12 left-experience experience">
                                    <div class="row">
                                        @php $counter=1 @endphp
                                        @foreach($category->subCatExperiences as $experience)

                                            <div class="col-lg-4 col-md-12 experience_{{$counter}}">
...
{{--                                                            <img class="double-img" src="{{ (isset($experience->futureimage) ? asset('storage/app/public/experience/'.$experience->futureimage) : asset('storage/app/public/experience/dummy.jpg')) }}">--}}
                                                        </a>
                                                    </div>
